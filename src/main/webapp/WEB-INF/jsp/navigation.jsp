    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/companies/findCompaniesForm">Find</a></li>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/customers/findCustomersForm">Find</a></li>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/projects/findProjectsForm">Find</a></li>
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="/skills/findSkillsForm">Find</a></li>
